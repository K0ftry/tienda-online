...
class Producto{
    ...
    public function registrar($_params){
        $sql = "INSERT INTO `productos`(`nombre`, `descripcion`, `foto`, `precio`, `categoria_id`, `fecha`) VALUES (:nombre,:descripcion,:foto,:precio,:categoria_id,:fecha)";
    ...
    public function actualizar($_params){
        ...
        $sql = "UPDATE `productos` SET `nombre`=:nombre,`descripcion`=:descripcion,`foto`=:foto,`precio`=:precio,`categoria_id`=:categoria_id,`fecha`=:fecha WHERE `id`=:id";
